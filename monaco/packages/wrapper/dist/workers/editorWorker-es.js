...
const cn = "Canceled";
function Tr(e) {
  return e instanceof Mr ? !0 : e instanceof Error && e.name === cn && e.message === cn;
}
...
function Et(e, t, n = 0, i = e.length) {
  let s = n, r = i;
  for (; s < r; ) {
...
function fn(e, t, n = 0, i = e.length) {
  let s = n, r = i;
  for (; s < r; ) {
    const a = Math.floor((s + r) / 2);
    t(e[a]) ? r = a : s = a + 1;
...
const tt = class tt {
  ...
  filter(t) {
    return new tt((n) => this.iterate((i) => t(i) ? n(i) : !0));
  }
  map(t) {
    return new tt((n) => this.iterate((i) => n(t(i))));
  }
  some(t) {
    let n = !1;
  ...
  findLastMaxBy(t) {
    let n, i = !0;
    return this.iterate((s) => ((i || hn.isGreaterThan(t(s, n))) && (i = !1, n = s), !0)), n;
  }
};
tt.empty = new tt((t) => {
});
...
(function(e) {
  ...
  e.reduce = A;
  function* x(w, E, D = w.length) {
    for (E < 0 && (E += w.length), D < 0 ? D += w.length : D > w.length && (D = w.length); E < D; E++)
      yield w[E];
  }
  e.slice = x;
  function R(w, E = Number.POSITIVE_INFINITY) {
    const D = [];
    if (E === 0)
      return [D, w];
    const T = w[Symbol.iterator]();
    for (let I = 0; I < E; I++) {
      const $ = T.next();
      if ($.done)
        return [D, e.empty()];
...
const Jt = class Jt {
  ...
  getDisposableData(t) {
    ...
    return n || (n = { parent: null, source: null, isSingleton: !1, value: t, idx: Jt.idx++ }, this.livingDisposables.set(t, n)), n;
  }
  trackDisposable(t) {
...
`)), p = Vr([...L].map((A) => s(A)[f]), (A) => A);
        delete p[c[f]];
        for (const [A, x] of Object.entries(p))
...
const Kt = class Kt {
  ...
  add(t) {
    ...
    return this._isDisposed ? Kt.DISABLE_DISPOSED_WARNING || console.warn(new Error(
...
Kt.DISABLE_DISPOSED_WARNING = !1;
let At = Kt;
const Wn = class Wn {
  constructor() {
    this._store = new At(), this._store;
  }
  dispose() {
    this._store.dispose();
  }
...
(function(e) {
  ...
  function n(v) {
    return (N, M = null, F) => {
      ...
      return q = v((z) => {
        if (!B)
          return q ? q.dispose() : B = !0, N.call(M, z);
      }, null, F), B && q.dispose(), q;
    };
  }
  e.once = n;
  function i(v, N, M) {
    return c((F, B = null, q) => v((z) => F.call(B, N(z)), null, q), M);
  }
  e.map = i;
  function s(v, N, M) {
    return c((F, B = null, q) => v((z) => {
      N(z), F.call(B, z);
    }, null, q), M);
  }
  e.forEach = s;
  function r(v, N, M) {
    return c((F, B = null, q) => v((z) => N(z) && F.call(B, z), null, q), M);
  }
  e.filter = r;
  function a(v) {
    return v;
  ...
  function u(...v) {
    return (N, M = null, F) => {
      const B = Gr(...v.map((q) => q((z) => N.call(M, z))));
      return h(B, F);
    };
  }
  e.any = u;
  ...
  function c(v, N) {
    ...
    return N == null || N.add(B), B.event;
  }
  function h(v, N) {
    return N instanceof Array ? N.push(v) : N && N.add(v), v;
  }
  function f(v, N, M = 100, F = !1, B = !1, q, z) {
    let se, ue, Xe, Tt = 0, qe;
    const xr = {
      leakWarningThreshold: q,
      onWillAddFirstListener() {
        se = v((Rr) => {
          Tt++, ue = N(ue, Rr), F && !Xe && (Mt.fire(ue), ue = void 0), qe = () => {
            const vr = ue;
            ue = void 0, Xe = void 0, (!F || Tt > 1) && Mt.fire(vr), Tt = 0;
          }, typeof M == "number" ? (clearTimeout(Xe), Xe = setTimeout(qe, M)) : Xe === void 0 && (Xe = 0, queueMicrotask(qe));
        });
      },
      ...
      onDidRemoveLastListener() {
        qe = void 0, se.dispose();
      }
    }, Mt = new pe(xr);
    return z == null || z.add(Mt), Mt.event;
  }
  e.debounce = f;
  function g(v, N = 0, M) {
    return e.debounce(v, (F, B) => F ? (F.push(B), F) : [B], N, void 0, !0, void 0, M);
  }
  e.accumulate = g;
  function b(v, N = (F, B) => F === B, M) {
    let F = !0, B;
    return r(v, (q) => {
      const z = F || !N(q, B);
      return F = !1, B = q, z;
  ...
  e.split = L;
  function p(v, N = !1, M = [], F) {
    let B = M.slice(), q = v((ue) => {
      B ? B.push(ue) : se.fire(ue);
    });
    F && F.add(q);
    const z = () => {
      B == null || B.forEach((ue) => se.fire(ue)), B = null;
    }, se = new pe({
      onWillAddFirstListener() {
        q || (q = v((ue) => se.fire(ue)), F && F.add(q));
      },
  ...
  class R {
    ...
    filter(N) {
      return this.steps.push((M) => N(M) ? M : x), this;
    }
    reduce(N, M) {
      let F = M;
      return this.steps.push((B) => (F = N(F, B), F)), this;
    }
    latch(N = (M, F) => M === F) {
      let M = !0, F;
      return this.steps.push((B) => {
        const q = M || !N(B, F);
        return M = !1, F = B, q ? B : x;
      }), this;
    }
    evaluate(N) {
  ...
  function U(v, N, M = (F) => F) {
    const F = (...se) => z.fire(M(...se)), B = () => v.on(N, F), q = () => v.removeListener(N, F), z = new pe(
      { onWillAddFirstListener: B, onDidRemoveLastListener: q }
    );
    return z.event;
  }
  e.fromNodeEventEmitter = U;
  function w(v, N, M = (F) => F) {
    const F = (...se) => z.fire(M(...se)), B = () => v.addEventListener(N, F), q = () => v.removeEventListener(N, F), z = new pe(
      { onWillAddFirstListener: B, onDidRemoveLastListener: q }
    );
    return z.event;
  }
  ...
  class I {
    constructor(N, M) {
      ...
      this.emitter = new pe(F), M && M.add(this.emitter);
    }
    beginUpdate(N) {
      this._counter++;
    }
  ...
  function $(v, N) {
    return new I(v, N).emitter.event;
  }
  e.fromObservable = $;
  function ne(v) {
    return (N, M, F) => {
      ...
      const z = {
        ...
        endUpdate() {
          B--, B === 0 && (v.reportChanges(), q && (q = !1, N.call(M)));
        },
      ...
      v.addObserver(z), v.reportChanges();
      const se = {
        dispose() {
          v.removeObserver(z);
        }
      };
      return F instanceof At ? F.add(se) : Array.isArray(F) && F.push(se), se;
    };
  }
...
const it = class it {
  constructor(t) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${it._idPool++}`, it.all.add(this);
  }
  start(t) {
    this._stopWatch = new nn(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
it.all = /* @__PURE__ */ new Set(), it._idPool = 0;
let gn = it, jr = -1;
const Ct = class Ct {
  constructor(t, n, i = (Ct._idPool++).toString(16).padStart(3, "0")) {
...
class pe {
  constructor(t) {
    var n, i, s, r;
    this._size = 0, this._options = t, this._leakageMon = (n = this._options) != null && n.leakWarningThreshold ? new _n(
      (t == null ? void 0 : t.onListenerError) ?? It,
      ((i = this._options) == null ? void 0 : i.leakWarningThreshold) ?? jr
    ) : void 0, this._perfMon = (s = this._options) != null && s._profName ? new gn(this._options._profName) : void 0, this._deliveryQueue = (r = this._options) == null ? void 0 : r.deliveryQueue;
  }
  dispose() {
    var t, n, i, s;
  ...
  get event() {
    return this._event ?? (this._event = (t, n, i) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(g);
        const b = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], L = new Yr(
          `${g}. HINT: Stack shows most frequent listener (${b[1]}-times)`,
          b[0]
        );
        return (((u = this._options) == null ? void 0 : u.onListenerError) || It)(L), ot.None;
      }
      if (this._disposed)
        return ot.None;
      n && (t = t.bind(n));
      const s = new sn(t);
      let r;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = Bn.create(), r = this._leakageMon.check(s.stack, this._size + 1)), this._listeners ? this._listeners instanceof sn ? (this._deliveryQueue ?? (this._deliveryQueue = new Jr()), this._listeners = [this._listeners, s]) : this._listeners.push(s) : ((c = (o = this._options) == null ? void 0 : o.onWillAddFirstListener) == null || c.call(o, this), this._listeners = s, (f = (h = this._options) == null ? void 0 : h.onDidAddFirstListener) == null || f.call(h, this)), this._size++;
      const a = qt(() => {
        r == null || r(), this._removeListener(s);
      });
      return i instanceof At ? i.add(a) : Array.isArray(i) && i.push(a), a;
    }), this._event;
  }
  _removeListener(t) {
    var r, a, u, o;
  ...
  _deliver(t, n) {
    ...
    if (!t)
      return;
    const i = ((s = this._options) == null ? void 0 : s.onListenerError) || It;
    if (!i) {
      t.value(n);
      return;
    }
  ...
  fire(t) {
    var n, i, s, r;
    if ((n = this._deliveryQueue) != null && n.current && (this._deliverQueue(this._deliveryQueue), (i = this._perfMon) == null || i.stop()), (s = this._perfMon) == null || s.start(this._size), this._listeners) if (this._listeners instanceof sn)
...
let tl = typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function nl(e, t) {
  let n;
  ...
  }), tl && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
let il = {};
function Y(e, t, n, ...i) {
  const s = typeof t == "object" ? t.key : t, r = (il[e] ?? {})[s] ?? n;
  return nl(r, i);
}
const Ke = "en";
let xt = !1, Rt = !1, St = !1, rr = !1, Ft, Pt = Ke, Xn = Ke, sl, Ne;
const $e = globalThis;
let ae;
var er;
typeof $e.vscode < "u" && typeof $e.vscode.process < "u" ? ae = $e.vscode.process : typeof process < "u" && typeof ((er = process == null ? void 0 : process.versions) == null ? void 0 : er.node) == "string" && (ae = process);
var tr;
const rl = typeof ((tr = ae == null ? void 0 : ae.versions) == null ? void 0 : tr.electron) == "string", ll = rl && (ae == null ? void 0 : ae.type) === "renderer";
if (typeof ae == "object") {
  xt = ae.platform === "win32", Rt = ae.platform === "darwin", St = ae.platform === "linux", St && ae.env.SNAP && ae.env.SNAP_REVISION, ae.env.CI || ae.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Ft = Ke, Pt = Ke;
  const e = ae.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e), n = t.availableLanguages["*"];
      Ft = t.locale, Xn = t.osLocale, Pt = n || Ke, sl = t._translationsConfigFile;
    } catch {
    }
} else typeof navigator == "object" && !ll ? (Ne = navigator.userAgent, xt = Ne.indexOf("Windows") >= 0, Rt = Ne.indexOf("Macintosh") >= 0, rr = (Ne.indexOf("Macintosh") >= 0 || Ne.indexOf("iPad") >= 0 || Ne.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, St = Ne.indexOf("Linux") >= 0, (Ne == null ? void 0 : Ne.indexOf("Mobi")) >= 0, Ft = Ke, Pt = Ft, Xn = navigator.language) : console.error("Unable to resolve platform.");
var rt;
(function(e) {
  e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows";
})(rt || (rt = {}));
rt.Web;
Rt ? rt.Mac : xt ? rt.Windows : St && rt.Linux;
const vt = xt, al = Rt, ve = Ne, Fe = Pt;
var Yn;
(function(e) {
  function t() {
    return Fe;
...
const ul = typeof $e.postMessage == "function" && !$e.importScripts;
(() => {
  if (ul) {
    const e = [];
...
Rt || rr ? dt.Macintosh : xt ? dt.Windows : dt.Linux;
const ol = !!(ve && ve.indexOf("Chrome") >= 0);
ve && ve.indexOf("Firefox") >= 0;
!ol && ve && ve.indexOf("Safari") >= 0;
ve && ve.indexOf("Edg/") >= 0;
...
(function(e) {
  function t(n) {
    return n === e.None || n === e.Cancelled || n instanceof Bt ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class Bt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? lr : (this._emitter || (this._emitter = new pe()), this._emitter.event);
  }
  dispose() {
...
class cl {
  ...
  get token() {
    return this._token || (this._token = new Bt()), this._token;
  }
  cancel() {
    this._token ? this._token instanceof Bt && this._token.cancel() : this._token = Wt.Cancelled;
  }
  dispose(t = !1) {
    var n;
    t && this.cancel(), (n = this._parentListener) == null || n.dispose(), this._token ? this._token instanceof Bt && this._token.dispose() : this._token = Wt.None;
  }
}
function fl(e) {
  return e;
...
class hl {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = fl) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
xe.ambiguousCharacterData = new Qn(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,8218,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,8242,96,1370,96,1523,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71922,67,71913,67,65315,67,8557,67,8450,67,8493,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71919,87,71910,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,66293,90,71909,90,65338,90,8484,90,8488,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65297,49,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"cs":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"es":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"fr":[65374,126,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"it":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ja":[8211,45,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65292,44,65307,59],"ko":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pt-BR":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ru":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"zh-hans":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41],"zh-hant":[8211,45,65374,126,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65307,59]}')), xe.cache = new hl({ getCacheKey: JSON.stringify }, (t) => {
  ...
  const r = xe.ambiguousCharacterData.value;
  ...
  return new xe(c);
}), xe._locales = new Qn(() => Object.keys(xe.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let Ut = xe;
const We = class We {
  static getRawData() {
  ...
  static getData() {
    return this._data || (this._data = new Set(We.getRawData())), this._data;
  }
  static isInvisibleCharacter(t) {
    return We.getData().has(t);
  }
  static containsInvisibleCharacter(t) {
    for (let n = 0; n < t.length; n++) {
      const i = t.codePointAt(n);
      if (typeof i == "number" && We.isInvisibleCharacter(i))
        return !0;
    }
    return !1;
  }
...
class Ul {
  ...
  sendMessage(t, n) {
    ...
    return new Promise((s, r) => {
      this._pendingReplies[i] = {
        resolve: s,
        reject: r
      }, this._send(new Al(this._workerId, i, t, n));
    });
  }
  listen(t, n) {
    let i = null;
    const s = new pe({
      onWillAddFirstListener: () => {
        i = String(++this._lastSentReq), this._pendingEmitters.set(i, s), this._send(new xl(this._workerId, i, t, n));
      },
      onDidRemoveLastListener: () => {
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.method, t.args).then((s) => {
      this._send(new Cn(this._workerId, n, s, void 0));
    }, (s) => {
      s.detail instanceof Error && (s.detail = Gn(s.detail)), this._send(new Cn(this._workerId, n, void 0, Gn(s)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.eventName, t.arg)((s) => {
      this._send(new Rl(this._workerId, n, s));
    });
...
function ur(e) {
  return e[0] === "o" && e[1] === "n" && ar(e.charCodeAt(2));
}
function or(e) {
  return /^onDynamic/.test(e) && ar(e.charCodeAt(9));
}
function Dl(e, t, n) {
  const i = (a) => function() {
...
class Tl {
  constructor(t, n) {
    this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Ul({
      sendMessage: (i, s) => {
        t(i, s);
      },
...
function Fl(e, t, n) {
  return new Oe(new ni(e), new ni(t)).ComputeDiff(n).changes;
}
class Qe {
  static Assert(t, n) {
    if (!t)
...
class ii {
  ...
  MarkNextChange() {
    (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new Se(
...
class Oe {
  constructor(t, n, i = null) {
    ...
    const [s, r, a] = Oe._getElements(t), [u, o, c] = Oe._getElements(n);
  ...
  ElementsAreStrictEqual(t, n) {
    if (!this.ElementsAreEqual(t, n))
      return !1;
    const i = Oe._getStrictElement(this._originalSequence, t), s = Oe._getStrictElement(this._modifiedSequence, n);
    return i === s;
  }
  ...
  ComputeDiffRecursive(t, n, i, s, r) {
    ...
    if (t > n || i > s) {
      let f;
      return i <= s ? (Qe.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), f = [
        new Se(t, 0, i, s - i + 1)
      ]) : t <= n ? (Qe.Assert(i === s + 1, "modifiedStart should only be one more than modifiedEnd"), f = [
        new Se(t, n - t + 1, i, 0)
      ]) : (Qe.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), Qe.Assert(i === s + 1, "modifiedStart should only be one more than modifiedEnd"), f = []), f;
    }
  ...
  WALKTRACE(t, n, i, s, r, a, u, o, c, h, f, g, b, L, p, A, x, R) {
    let U = null, w = null, E = new ii(), D = n, T = i, I = b[0] - A[0] - s, $ = de.MIN_SAFE_SMALL_INTEGER, ne = this.m_forwardHistory.length - 1;
    do {
      const v = I + t;
      v === D || v < T && c[v - 1] < c[v + 1] ? (f = c[v + 1], L = f - I - s, f < $ && E.MarkNextChange(), $ = f, E.AddModifiedElement(f + 1, L), I = v + 1 - t) : (f = c[v - 1] + 1, L = f - I - s, f < $ && E.MarkNextChange(), $ = f - 1, E.AddOriginalElement(f, L + 1), I = v - 1 - t), ne >= 0 && (c = this.m_forwardHistory[ne], t = c[0], D = 1, T = c.length - 1);
    } while (--ne >= -1);
    if (U = E.getReverseChanges(), R[0]) {
      let v = b[0] + 1, N = A[0] + 1;
      if (U !== null && U.length > 0) {
        const M = U[U.length - 1];
        v = Math.max(v, M.getOriginalEnd()), N = Math.max(N, M.getModifiedEnd());
      }
      w = [
        new Se(
          v,
      ...
      E = new ii(), D = a, T = u, I = b[0] - A[0] - o, $ = de.MAX_SAFE_SMALL_INTEGER, ne = x ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const v = I + r;
        v === D || v < T && h[v - 1] >= h[v + 1] ? (f = h[v + 1] - 1, L = f - I - o, f > $ && E.MarkNextChange(), $ = f + 1, E.AddOriginalElement(f + 1, L + 1), I = v + 1 - r) : (f = h[v - 1], L = f - I - o, f > $ && E.MarkNextChange(), $ = f, E.AddModifiedElement(f + 1, L + 1), I = v - 1 - r), ne >= 0 && (h = this.m_reverseHistory[ne], r = h[0], D = 1, T = h.length - 1);
      } while (--ne >= -1);
      w = E.getChanges();
    }
    return this.ConcatenateChanges(U, w);
  }
  ComputeRecursionPoint(t, n, i, s, r, a, u) {
    ...
    const L = n - t + (s - i), p = L + 1, A = new Int32Array(p), x = new Int32Array(p), R = s - i, U = n - t, w = t - i, E = n - s, T = (U - R) % 2 === 0;
    A[R] = t, x[U] = n, u[0] = !1;
    for (let I = 1; I <= L / 2 + 1; I++) {
      let $ = 0, ne = 0;
      h = this.ClipDiagonalBound(R - I, I, R, p), f = this.ClipDiagonalBound(R + I, I, R, p);
      for (let N = h; N <= f; N += 2) {
        N === h || N < f && A[N - 1] < A[N + 1] ? o = A[N + 1] : o = A[N - 1] + 1, c = o - (N - R) - w;
        const M = o;
        for (; o < n && c < s && this.ElementsAreEqual(o + 1, c + 1); )
          o++, c++;
        if (A[N] = o, o + c > $ + ne && ($ = o, ne = c), !T && Math.abs(N - U) <= I - 1 && o >= x[N])
          return r[0] = o, a[0] = c, M <= x[N] && Ue.MaxDifferencesHistory > 0 && I <= Ue.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, h, f, w, U, g, b, E, A, x, o, n, r, c, s, a, T, u) : null;
      }
      const v = ($ - t + (ne - i) - I) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate($, v))
        return u[0] = !0, r[0] = $, a[0] = ne, v > 0 && Ue.MaxDifferencesHistory > 0 && I <= Ue.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, h, f, w, U, g, b, E, A, x, o, n, r, c, s, a, T, u) : (t++, i++, [
          new Se(
            t,
            n - t + 1,
            i,
      ...
      g = this.ClipDiagonalBound(U - I, I, U, p), b = this.ClipDiagonalBound(U + I, I, U, p);
      for (let N = g; N <= b; N += 2) {
        N === g || N < b && x[N - 1] >= x[N + 1] ? o = x[N + 1] - 1 : o = x[N - 1], c = o - (N - U) - E;
        const M = o;
        for (; o > t && c > i && this.ElementsAreEqual(o, c); )
          o--, c--;
        if (x[N] = o, T && Math.abs(N - R) <= I && o <= A[N])
          return r[0] = o, a[0] = c, M >= A[N] && Ue.MaxDifferencesHistory > 0 && I <= Ue.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, h, f, w, U, g, b, E, A, x, o, n, r, c, s, a, T, u) : null;
      }
      if (I <= Ue.MaxDifferencesHistory) {
        let N = new Int32Array(f - h + 2);
        N[0] = R - h + 1, Ze.Copy2(A, h, N, 1, f - h + 1), this.m_forwardHistory.push(N), N = new Int32Array(b - g + 2), N[0] = U - g + 1, Ze.Copy2(x, g, N, 1, b - g + 1), this.m_reverseHistory.push(N);
      }
    }
    return this.WALKTRACE(R, h, f, w, U, g, b, E, A, x, o, n, r, c, s, a, T, u);
  }
  PrettifyChanges(t) {
    for (let n = 0; n < t.length; n++) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      for (let f = 1; ; f++) {
        ...
        if (g < s || b < r || a && !this.OriginalElementsAreEqual(g, g + i.originalLength) || u && !this.ModifiedElementsAreEqual(b, b + i.modifiedLength))
          break;
        const p = (g === s && b === r ? 5 : 0) + this._boundaryScore(g, i.originalLength, b, i.modifiedLength);
        p > c && (c = p, o = f);
      }
    ...
    if (this._hasStrings)
      for (let n = 1, i = t.length; n < i; n++) {
        ...
        if (a < 5 && c < 20 && g < 20) {
          ...
          if (b) {
            const [L, p] = b;
            (L !== s.originalStart + s.originalLength || p !== s.modifiedStart + s.modifiedLength) && (s.originalLength = L - s.originalStart, s.modifiedLength = p - s.modifiedStart, r.originalStart = L + a, r.modifiedStart = p + a, r.originalLength = o - r.originalStart, r.modifiedLength = f - r.modifiedStart);
          }
        }
      }
    return t;
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], i)) {
      ...
      return Ze.Copy(t, 0, s, 0, t.length - 1), s[t.length - 1] = i[0], Ze.Copy(n, 1, s, t.length, n.length - 1), s;
    } else {
      const s = new Array(t.length + n.length);
      return Ze.Copy(t, 0, s, 0, t.length), Ze.Copy(n, 0, s, t.length, n.length), s;
    }
  }
  ChangesOverlap(t, n, i) {
    if (Qe.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Qe.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (r = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (u = n.modifiedStart + n.modifiedLength - t.modifiedStart), i[0] = new Se(s, r, a, u), !0;
    } else
      return i[0] = null, !1;
  }
...
if (typeof rn < "u" && typeof rn.process < "u") {
...
} else typeof process < "u" && typeof ((nr = process == null ? void 0 : process.versions) == null ? void 0 : nr.node) == "string" ? ze = {
  get platform() {
  ...
  get platform() {
    return vt ? "win32" : al ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
const Gt = ze.cwd, kl = ze.env, Il = ze.platform;
ze.arch;
const Sl = 65, Pl = 97, Bl = 90, Ol = 122, ye = 46, re = 47, fe = 92, ke = 58, yl = 63;
...
function $t(e, t, n, i) {
  ...
  for (let c = 0; c <= e.length; ++c) {
    ...
    if (i(o)) {
      if (!(a === c - 1 || u === 1)) if (u === 2) {
        if (s.length < 2 || r !== 2 || s.charCodeAt(s.length - 1) !== ye || s.charCodeAt(s.length - 2) !== ye) {
          if (s.length > 2) {
...
const ie = {
  resolve(...e) {
    ...
    for (let s = e.length - 1; s >= -1; s--) {
      let r;
      if (s >= 0) {
        if (r = e[s], C(r, "path"), r.length === 0)
          continue;
      } else t.length === 0 ? r = Gt() : (r = kl[`=${t}`] || Gt(), (r === void 0 || r.slice(0, 2).toLowerCase() !== t.toLowerCase() && r.charCodeAt(2) === fe) && (r = `${t}\\`));
      const a = r.length;
      let u = 0, o = "", c = !1;
      ...
      if (a === 1)
        ...
        if (c = !0, H(r.charCodeAt(1))) {
          ...
          u = 1;
      else Ie(h) && r.charCodeAt(1) === ke && (o = r.slice(0, 2), u = 2, a > 2 && H(r.charCodeAt(2)) && (c = !0, u = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (H(r))
      if (s = !0, H(e.charCodeAt(1))) {
        ...
        n = 1;
    else Ie(r) && e.charCodeAt(1) === ke && (i = e.slice(0, 2), n = 2, t > 2 && H(e.charCodeAt(2)) && (s = !0, n = 3));
    let a = n < t ? $t(e.slice(n), !s, "\\", H) : "";
  ...
  isAbsolute(e) {
    ...
    return H(n) || t > 2 && Ie(n) && e.charCodeAt(1) === ke && H(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let r = 0; r < e.length; ++r) {
      const a = e[r];
      C(a, "path"), a.length > 0 && (t === void 0 ? t = n = a : t += `\\${a}`);
    }
    if (t === void 0)
      return ".";
    let i = !0, s = 0;
  ...
  toNamespacedPath(e) {
    ...
    } else if (Ie(t.charCodeAt(0)) && t.charCodeAt(1) === ke && t.charCodeAt(2) === fe)
      return `\\\\?\\${t}`;
    return e;
  },
  dirname(e) {
    ...
    } else Ie(s) && e.charCodeAt(1) === ke && (n = t > 2 && H(e.charCodeAt(2)) ? 3 : 2, i = n);
    let r = -1, a = !0;
    for (let u = t - 1; u >= i; --u)
      if (H(e.charCodeAt(u))) {
        if (!a) {
  ...
  basename(e, t) {
    t !== void 0 && C(t, "ext"), C(e, "path");
    let n = 0, i = -1, s = !0, r;
    if (e.length >= 2 && Ie(e.charCodeAt(0)) && e.charCodeAt(1) === ke && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === ke && Ie(e.charCodeAt(0)) && (t = i = 2);
    for (let u = e.length - 1; u >= t; --u) {
      ...
      s === -1 && (r = !1, s = u + 1), o === ye ? n === -1 ? n = u : a !== 1 && (a = 1) : n !== -1 && (a = -1);
    }
  ...
  parse(e) {
    ...
    } else if (Ie(s) && e.charCodeAt(1) === ke) {
      if (n <= 2)
    ...
    for (; c >= i; --c) {
      ...
      u === -1 && (o = !1, u = c + 1), s === ye ? r === -1 ? r = c : h !== 1 && (h = 1) : r !== -1 && (h = -1);
    }
  ...
  resolve(...e) {
    ...
    for (let i = e.length - 1; i >= -1 && !n; i--) {
      const s = i >= 0 ? e[i] : Hl();
      C(s, "path"), s.length !== 0 && (t = `${s}/${t}`, n = s.charCodeAt(0) === re);
    }
    return t = $t(t, !n, "/", Nn), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (C(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === re, n = e.charCodeAt(e.length - 1) === re;
    return e = $t(e, !t, "/", Nn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
    return C(e, "path"), e.length > 0 && e.charCodeAt(0) === re;
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let n = 0; n < e.length; ++n) {
      const i = e[n];
      C(i, "path"), i.length > 0 && (t === void 0 ? t = i : t += `/${i}`);
    }
    return t === void 0 ? "." : le.normalize(t);
  },
  relative(e, t) {
    if (C(e, "from"), C(t, "to"), e === t || (e = le.resolve(e), t = le.resolve(t), e === t))
      return "";
  ...
  extname(e) {
    ...
    for (let a = e.length - 1; a >= 0; --a) {
      ...
      i === -1 && (s = !1, i = a + 1), u === ye ? t === -1 ? t = a : r !== 1 && (r = 1) : t !== -1 && (r = -1);
    }
  ...
  parse(e) {
    ...
    for (; o >= i; --o) {
      ...
      a === -1 && (u = !1, a = o + 1), h === ye ? s === -1 ? s = o : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
    if (a !== -1) {
      const h = r === 0 && n ? 1 : r;
...
Le ? ie.normalize : le.normalize;
Le ? ie.isAbsolute : le.isAbsolute;
Le ? ie.join : le.join;
Le ? ie.resolve : le.resolve;
Le ? ie.relative : le.relative;
Le ? ie.dirname : le.dirname;
Le ? ie.basename : le.basename;
Le ? ie.extname : le.extname;
Le ? ie.parse : le.parse;
Le ? ie.sep : le.sep;
Le ? ie.delimiter : le.delimiter;
const ql = /^\w[\w\d+.-]*$/, Wl = /^\//, Gl = /^\/\//;
function $l(e, t) {
  if (!e.scheme && t)
    throw new Error(
      `[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`
    );
  if (e.scheme && !ql.test(e.scheme))
...
class je {
  static isUri(t) {
    return t instanceof je ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1;
  }
  constructor(t, n, i, s, r, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || j, this.authority = t.authority || j, this.path = t.path || j, this.query = t.query || j, this.fragment = t.fragment || j) : (this.scheme = zl(t, a), this.authority = n || j, this.path = jl(this.scheme, i || j), this.query = s || j, this.fragment = r || j, $l(this, a));
  }
  get fsPath() {
    return pn(this, !1);
  }
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = j), i === void 0 ? i = this.authority : i === null && (i = j), s === void 0 ? s = this.path : s === null && (s = j), r === void 0 ? r = this.query : r === null && (r = j), a === void 0 ? a = this.fragment : a === null && (a = j), n === this.scheme && i === this.authority && s === this.path && r === this.query && a === this.fragment ? this : new Je(n, i, s, r, a);
  }
  static parse(t, n = !1) {
    const i = Xl.exec(t);
    return i ? new Je(
  ...
  static file(t) {
    let n = j;
    if (vt && (t = t.replace(/\\/g, we)), t[0] === we && t[1] === we) {
      const i = t.indexOf(we, 2);
      i === -1 ? (n = t.substring(2), t = we) : (n = t.substring(2, i), t = t.substring(i) || we);
    }
    return new Je("file", n, t, j, j);
  }
  static from(t, n) {
    return new Je(
      t.scheme,
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return vt && t.scheme === "file" ? i = je.file(ie.join(pn(t, !0), ...n)).path : i = le.join(t.path, ...n), t.with({ path: i });
  }
  toString(t = !1) {
    return wn(this, t);
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new Je(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === hr ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
}
const hr = vt ? 1 : void 0;
class Je extends je {
  constructor() {
  ...
  toJSON() {
    ...
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = hr), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const mr = {
  [d.Colon]: "%3A",
...
function Yl(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === d.Hash || i === d.QuestionMark ? (t === void 0 && (t = e.substr(0, n)), t += mr[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function pn(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === d.Slash && (e.path.charCodeAt(1) >= d.A && e.path.charCodeAt(1) <= d.Z || e.path.charCodeAt(1) >= d.a && e.path.charCodeAt(1) <= d.z) && e.path.charCodeAt(2) === d.Colon ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, vt && (n = n.replace(/\//g, "\\")), n;
}
function wn(e, t) {
  const n = t ? Yl : si;
  let i = "", { scheme: s, authority: r, path: a, query: u, fragment: o } = e;
  if (s && (i += s, i += ":"), (r || s === "file") && (i += we, i += we), r) {
    let c = r.indexOf("@");
    if (c !== -1) {
  ...
  return u && (i += "?", i += n(u, !1, !1)), o && (i += "#", i += t ? o : si(o, !1, !1)), i;
}
function gr(e) {
  try {
    return decodeURIComponent(e);
  } catch {
    return e.length > 3 ? e.substr(0, 3) + gr(e.substr(3)) : e;
  }
}
const ri = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function kt(e) {
  return e.match(ri) ? e.replace(ri, (t) => gr(t)) : e;
}
class te {
  constructor(t, n) {
...
class y {
  ...
  static intersectRanges(t, n) {
    ...
    return i < u ? (i = u, s = o) : i === u && (s = Math.max(s, o)), r > c ? (r = c, a = h) : r === c && (a = Math.min(a, h)), i > r || i === r && s > a ? null : new y(
      i,
      s,
      r,
      a
  ...
  setEndPosition(t, n) {
    return new y(this.startLineNumber, this.startColumn, t, n);
  }
  setStartPosition(t, n) {
    return new y(t, n, this.endLineNumber, this.endColumn);
  }
  collapseToStart() {
  ...
  static fromPositions(t, n = t) {
    return new y(t.lineNumber, t.column, n.lineNumber, n.column);
  }
  static lift(t) {
    return t ? new y(
      t.startLineNumber,
...
function On(e, t, n, i, s) {
  if (t = br(t), s || (s = Ht.first(dr)), n.length > s.maxLen) {
    let c = e - s.maxLen / 2;
    return c < 0 ? c = 0 : i += c, n = n.substring(c, e + s.maxLen / 2), On(e, t, n, i, s);
  }
...
function s1() {
  if (ht === null) {
    ...
    const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`;
    for (let n = 0; n < e.length; n++)
      ht.set(e.charCodeAt(n), X.ForceTermination);
    const t = ".,;:";
    for (let n = 0; n < t.length; n++)
      ht.set(t.charCodeAt(n), X.CannotEndIn);
  }
  return ht;
}
class zt {
        ...
        if (g === P.Accept) {
          ...
          switch (R) {
            case d.OpenParen:
              ...
              break;
            case d.CloseParen:
              U = b ? X.None : X.ForceTermination;
              break;
            case d.OpenSquareBracket:
              p = !0, L = !0, U = X.None;
              break;
            case d.CloseSquareBracket:
              p = !1, U = L ? X.None : X.ForceTermination;
              break;
            case d.OpenCurlyBrace:
              A = !0, U = X.None;
              break;
            case d.CloseCurlyBrace:
              U = A ? X.None : X.ForceTermination;
              break;
            case d.SingleQuote:
            case d.DoubleQuote:
            case d.BackTick:
              f === R ? U = X.ForceTermination : f === d.SingleQuote || f === d.DoubleQuote || f === d.BackTick ? U = X.None : U = X.ForceTermination;
              break;
            case d.Asterisk:
              U = f === d.Asterisk ? X.ForceTermination : X.None;
              break;
            case d.Pipe:
              U = f === d.Pipe ? X.ForceTermination : X.None;
              break;
            case d.Space:
              U = p ? X.None : X.ForceTermination;
              break;
            default:
              U = i.get(R);
          }
          U === X.ForceTermination && (s.push(zt._createLink(i, u, r, h, c)), x = !0);
        } else if (g === P.End) {
          let U;
          R === d.OpenSquareBracket ? (L = !0, U = X.None) : U = i.get(R), U === X.ForceTermination ? x = !0 : g = P.Accept;
        } else
...
const Ot = new Vn(), An = new Vn(), xn = new Vn(), l1 = new Array(230), a1 = /* @__PURE__ */ Object.create(null), u1 = /* @__PURE__ */ Object.create(null), Rn = [];
for (let e = 0; e <= _.MAX_VALUE; e++)
  m.DependsOnKbLayout;
for (let e = 0; e <= m.MAX_VALUE; e++)
  Rn[e] = _.DependsOnKbLayout;
(function() {
  const e = "", t = [
  ...
  for (const s of t) {
    ...
    if (i[a] || (i[a] = !0, a1[u] = a, u1[u.toLowerCase()] = a, r && o !== m.Unknown && o !== m.Enter && o !== m.Ctrl && o !== m.Shift && o !== m.Alt && o !== m.Meta && (Rn[o] = a)), !n[o]) {
      if (n[o] = !0, !c)
        throw new Error(
          `String representation missing for key code ${o} around scan code ${u}`
        );
      Ot.define(o, c), An.define(o, g || c), xn.define(o, b || g || c);
    }
    h && (l1[h] = o);
  }
  Rn[m.Enter] = _.Enter;
...
(function(e) {
  function t(u) {
    return Ot.keyCodeToStr(u);
  }
  e.toString = t;
  function n(u) {
    return Ot.strToKeyCode(u);
  }
  e.fromString = n;
  function i(u) {
  ...
  function r(u) {
    return An.strToKeyCode(u) || xn.strToKeyCode(u);
  }
...
class me extends y {
  ...
  getDirection() {
    return this.selectionStartLineNumber === this.startLineNumber && this.selectionStartColumn === this.startColumn ? Pe.LTR : Pe.RTL;
  }
  setEndPosition(t, n) {
    return this.getDirection() === Pe.LTR ? new me(this.startLineNumber, this.startColumn, t, n) : new me(t, n, this.startLineNumber, this.startColumn);
  }
  getPosition() {
  ...
  setStartPosition(t, n) {
    return this.getDirection() === Pe.LTR ? new me(t, n, this.endLineNumber, this.endColumn) : new me(this.endLineNumber, this.endColumn, t, n);
  }
  static fromPositions(t, n = t) {
    return new me(t.lineNumber, t.column, n.lineNumber, n.column);
  }
  static fromRange(t, n) {
    return n === Pe.LTR ? new me(
      t.startLineNumber,
      t.startColumn,
      t.endLineNumber,
      t.endColumn
  ...
  static createWithDirection(t, n, i, s, r) {
    return r === Pe.LTR ? new me(t, n, i, s) : new me(i, s, t, n);
  }
}
...
const Q = "vs/editor/common/languages";
class g1 {
  constructor(t, n, i) {
...
(function(e) {
  const t = /* @__PURE__ */ new Map();
  t.set(k.Method, S.symbolMethod), t.set(k.Function, S.symbolFunction), t.set(k.Constructor, S.symbolConstructor), t.set(k.Field, S.symbolField), t.set(k.Variable, S.symbolVariable), t.set(k.Class, S.symbolClass), t.set(k.Struct, S.symbolStruct), t.set(k.Interface, S.symbolInterface), t.set(k.Module, S.symbolModule), t.set(k.Property, S.symbolProperty), t.set(k.Event, S.symbolEvent), t.set(k.Operator, S.symbolOperator), t.set(k.Unit, S.symbolUnit), t.set(k.Value, S.symbolValue), t.set(k.Enum, S.symbolEnum), t.set(k.Constant, S.symbolConstant), t.set(k.Enum, S.symbolEnum), t.set(k.EnumMember, S.symbolEnumMember), t.set(k.Keyword, S.symbolKeyword), t.set(k.Snippet, S.symbolSnippet), t.set(k.Text, S.symbolText), t.set(k.Color, S.symbolColor), t.set(k.File, S.symbolFile), t.set(k.Reference, S.symbolReference), t.set(k.Customcolor, S.symbolCustomColor), t.set(k.Folder, S.symbolFolder), t.set(k.TypeParameter, S.symbolTypeParameter), t.set(k.User, S.account), t.set(k.Issue, S.issues);
  function n(r) {
    let a = t.get(r);
    return a || (console.info("No codicon found for CompletionItemKind " + r), a = S.symbolProperty), a;
  }
  e.toIcon = n;
  const i = /* @__PURE__ */ new Map();
  i.set("method", k.Method), i.set("function", k.Function), i.set("constructor", k.Constructor), i.set("field", k.Field), i.set("variable", k.Variable), i.set("class", k.Class), i.set("struct", k.Struct), i.set("interface", k.Interface), i.set("module", k.Module), i.set("property", k.Property), i.set("event", k.Event), i.set("operator", k.Operator), i.set("unit", k.Unit), i.set("value", k.Value), i.set("constant", k.Constant), i.set("enum", k.Enum), i.set("enum-member", k.EnumMember), i.set("enumMember", k.EnumMember), i.set("keyword", k.Keyword), i.set("snippet", k.Snippet), i.set("text", k.Text), i.set("color", k.Color), i.set("file", k.File), i.set("reference", k.Reference), i.set("customcolor", k.Customcolor), i.set("folder", k.Folder), i.set("type-parameter", k.TypeParameter), i.set("typeParameter", k.TypeParameter), i.set("account", k.User), i.set("issue", k.Issue);
  function s(r, a) {
    let u = i.get(r);
    return typeof u > "u" && !a && (u = k.Property), u;
  }
  e.fromString = s;
})(gi || (gi = {}));
var _i;
...
O.Array + "", Y(Q, 0, "array"), O.Boolean + "", Y(Q, 1, "boolean"), O.Class + "", Y(Q, 2, "class"), O.Constant + "", Y(Q, 3, "constant"), O.Constructor + "", Y(Q, 4, "constructor"), O.Enum + "", Y(Q, 5, "enumeration"), O.EnumMember + "", Y(Q, 6, "enumeration member"), O.Event + "", Y(Q, 7, "event"), O.Field + "", Y(Q, 8, "field"), O.File + "", Y(Q, 9, "file"), O.Function + "", Y(Q, 10, "function"), O.Interface + "", Y(Q, 11, "interface"), O.Key + "", Y(Q, 12, "key"), O.Method + "", Y(Q, 13, "method"), O.Module + "", Y(Q, 14, "module"), O.Namespace + "", Y(Q, 15, "namespace"), O.Null + "", Y(Q, 16, "null"), O.Number + "", Y(Q, 17, "number"), O.Object + "", Y(Q, 18, "object"), O.Operator + "", Y(Q, 19, "operator"), O.Package + "", Y(Q, 20, "package"), O.Property + "", Y(Q, 21, "property"), O.String + "", Y(Q, 22, "string"), O.Struct + "", Y(Q, 23, "struct"), O.TypeParameter + "", Y(Q, 24, "type parameter"), O.Variable + "", Y(Q, 25, "variable");
var xi;
(function(e) {
  e[e.Deprecated = 1] = "Deprecated";
})(xi || (xi = {}));
...
(function(e) {
  const t = /* @__PURE__ */ new Map();
  t.set(O.File, S.symbolFile), t.set(O.Module, S.symbolModule), t.set(O.Namespace, S.symbolNamespace), t.set(O.Package, S.symbolPackage), t.set(O.Class, S.symbolClass), t.set(O.Method, S.symbolMethod), t.set(O.Property, S.symbolProperty), t.set(O.Field, S.symbolField), t.set(O.Constructor, S.symbolConstructor), t.set(O.Enum, S.symbolEnum), t.set(O.Interface, S.symbolInterface), t.set(O.Function, S.symbolFunction), t.set(O.Variable, S.symbolVariable), t.set(O.Constant, S.symbolConstant), t.set(O.String, S.symbolString), t.set(O.Number, S.symbolNumber), t.set(O.Boolean, S.symbolBoolean), t.set(O.Array, S.symbolArray), t.set(O.Object, S.symbolObject), t.set(O.Key, S.symbolKey), t.set(O.Null, S.symbolNull), t.set(O.EnumMember, S.symbolEnumMember), t.set(O.Struct, S.symbolStruct), t.set(O.Event, S.symbolEvent), t.set(O.Operator, S.symbolOperator), t.set(O.TypeParameter, S.symbolTypeParameter);
  function n(i) {
    let s = t.get(i);
    return s || (console.info("No codicon found for SymbolKind " + i), s = S.symbolProperty), s;
  }
  e.toIcon = n;
})(Ri || (Ri = {}));
const _e = class _e {
...
_e.Comment = new _e("comment"), _e.Imports = new _e("imports"), _e.Region = new _e("region");
let vi = _e;
var Ui;
(function(e) {
...
st.CtrlCmd = Ce.CtrlCmd, st.Shift = Ce.Shift, st.Alt = Ce.Alt, st.WinCtrl = Ce.WinCtrl;
let Mn = st;
function _1() {
  return {
    editor: void 0,
    languages: void 0,
    CancellationTokenSource: cl,
    Emitter: pe,
    KeyCode: vn,
    KeyMod: Mn,
    Position: te,
...
function b1(e, t, n, i, s) {
  if (i === 0)
    return !0;
  const r = t.charCodeAt(i - 1);
  if (e.get(r) !== ct.Regular || r === d.CarriageReturn || r === d.LineFeed)
    return !0;
  if (s > 0) {
    const a = t.charCodeAt(i);
    if (e.get(a) !== ct.Regular)
      return !0;
  }
  return !1;
}
function d1(e, t, n, i, s) {
  if (i + s === n)
    return !0;
...
function L1(e, t, n, i, s) {
  return b1(e, t, n, i, s) && d1(e, t, n, i, s);
}
class N1 {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (s === this._prevMatchStartIndex && r === this._prevMatchLength) {
        if (r === 0) {
          Nl(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = s, this._prevMatchLength = r, !this._wordSeparators || L1(this._wordSeparators, t, n, s, r))
        return i;
    } while (i);
    return null;
  }
}
function p1(e, t = "Unreachable") {
  throw new Error(t);
}
function Xt(e) {
  if (!e()) {
    debugger;
    e(), It(new Ae("Assertion Failed"));
  }
}
function Lr(e, t) {
  let n = 0;
...
class w1 {
  static computeUnicodeHighlights(t, n, i) {
    const s = i ? i.startLineNumber : 1, r = i ? i.endLineNumber : t.getLineCount(), a = new Bs(n), u = a.getCandidateCodePoints();
    let o;
    u === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${E1(Array.from(u))}`, "g");
    const c = new N1(null, o), h = [];
    let f = !1, g, b = 0, L = 0, p = 0;
    e: for (let A = s, x = r; A <= x; A++) {
      const R = t.getLineContent(A), U = R.length;
      c.reset(0);
      do
        if (g = c.next(R), g) {
          let w = g.index, E = g.index + g[0].length;
          if (w > 0) {
            const $ = R.charCodeAt(w - 1);
            dn($) && w--;
          }
          if (E + 1 < U) {
            const $ = R.charCodeAt(E - 1);
            dn($) && E++;
          }
          const D = R.substring(w, E);
          let T = On(w + 1, _r, R, 0);
          T && T.endColumn <= w + 1 && (T = null);
          const I = a.shouldHighlightNonBasicASCII(D, T ? T.word : null);
          if (I !== ce.None) {
            if (I === ce.Ambiguous ? b++ : I === ce.Invisible ? L++ : I === ce.NonBasicASCII ? p++ : p1(), h.length >= 1e3) {
              f = !0;
              break e;
            }
            h.push(new y(A, w + 1, A, E + 1));
          }
        }
      while (g);
    }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      case ce.None:
        return null;
      case ce.Invisible:
        return { kind: Nt.Invisible };
      case ce.Ambiguous: {
        const r = t.codePointAt(0), a = i.ambiguousCharacters.getPrimaryConfusable(r), u = Ut.getLocales().filter((o) => !Ut.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, o])).isAmbiguous(r));
        return { kind: Nt.Ambiguous, confusableWith: String.fromCodePoint(a), notAmbiguousInLocales: u };
      }
      case ce.NonBasicASCII:
        return { kind: Nt.NonBasicAscii };
    }
  }
}
function E1(e, t) {
  return `[${ml(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
}
var Nt;
(function(e) {
...
class Bs {
  constructor(t) {
    this.options = t, this.allowedCodePoints = new Set(t.allowedCodePoints), this.ambiguousCharacters = Ut.getInstance(new Set(t.allowedLocales));
  }
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const u = a.codePointAt(0), o = wl(a);
        s = s || o, !o && !this.ambiguousCharacters.isAmbiguous(u) && !Lt.isInvisibleCharacter(u) && (r = !0);
      }
    return !s && r ? ce.None : this.options.invisibleCharacters && !Os(t) && Lt.isInvisibleCharacter(i) ? ce.Invisible : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? ce.Ambiguous : ce.None;
  }
}
function Os(e) {
  return e === " " || e === `
...
class V {
  ...
  static joinMany(t) {
    if (t.length === 0)
      return [];
    let n = new Re(t[0].slice());
    for (let i = 1; i < t.length; i++)
      n = n.getUnion(new Re(t[i].slice()));
    return n.ranges;
  }
  static join(t) {
    if (t.length === 0)
...
class Re {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = fn(this._normalizedRanges, (s) => s.endLineNumberExclusive >= t.startLineNumber), i = Et(this._normalizedRanges, (s) => s.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  contains(t) {
    const n = ut(this._normalizedRanges, (i) => i.startLineNumber <= t);
    return !!n && n.endLineNumberExclusive > t;
  }
  intersects(t) {
    const n = ut(this._normalizedRanges, (i) => i.startLineNumber < t.endLineNumberExclusive);
  ...
  getUnion(t) {
    ...
    return r !== null && n.push(r), new Re(n);
  }
  subtractFrom(t) {
    const n = fn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), i = Et(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Re([t]);
    const s = [];
    ...
    return r < t.endLineNumberExclusive && s.push(new V(r, t.endLineNumberExclusive)), new Re(s);
  }
  toString() {
  ...
  getWithDelta(t) {
    return new Re(this._normalizedRanges.map((n) => n.delta(t)));
  }
}
const ge = class ge {
  static lengthDiffNonNegative(t, n) {
    return n.isLessThan(t) ? ge.zero : t.lineCount === n.lineCount ? new ge(0, n.columnCount - t.columnCount) : new ge(n.lineCount - t.lineCount, n.columnCount);
  }
  static betweenPositions(t, n) {
    return t.lineNumber === n.lineNumber ? new ge(0, n.column - t.column) : new ge(n.lineNumber - t.lineNumber, n.column - 1);
  }
  static ofRange(t) {
    return ge.betweenPositions(t.getStartPosition(), t.getEndPosition());
  }
  static ofText(t) {
    let n = 0, i = 0;
    for (const s of t)
...
` ? (n++, i = 0) : i++;
  ...
  add(t) {
    return t.lineCount === 0 ? new ge(this.lineCount, this.columnCount + t.columnCount) : new ge(this.lineCount + t.lineCount, t.columnCount);
  }
  createRange(t) {
...
class Ee {
  static inverse(t, n, i) {
    ...
    let r = 1, a = 1;
    for (const o of t) {
      const c = new Ee(new V(r, o.original.startLineNumber), new V(a, o.modified.startLineNumber));
      c.modified.isEmpty || s.push(c), r = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
    }
    const u = new Ee(new V(r, n + 1), new V(a, i + 1));
  ...
  static clip(t, n, i) {
    ...
    for (const r of t) {
      ...
      a && !a.isEmpty && u && !u.isEmpty && s.push(new Ee(a, u));
    }
    return s;
  }
  constructor(t, n) {
  ...
  flip() {
    return new Ee(this.modified, this.original);
  }
  join(t) {
    return new Ee(this.original.join(t.original), this.modified.join(t.modified));
  }
  ...
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new Ve(new y(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new y(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new Ve(new y(
...
class Te extends Ee {
  ...
  flip() {
    var t;
    return new Te(this.modified, this.original, (t = this.innerChanges) == null ? void 0 : t.map((n) => n.flip()));
  }
...
class Ve {
  ...
  toTextEdit(t) {
    ...
    return new A1(this.originalRange, n);
  }
}
const x1 = 3;
class R1 {
  computeDiff(t, n, i) {
    ...
    for (const c of r.changes) {
      ...
      let g = new Te(h, f, (o = c.charChanges) == null ? void 0 : o.map((b) => new Ve(new y(
      ...
      u && (u.modified.endLineNumberExclusive === g.modified.startLineNumber || u.original.endLineNumberExclusive === g.original.startLineNumber) && (g = new Te(
    ...
    return Xt(() => Lr(a, (c, h) => h.original.startLineNumber - c.original.endLineNumberExclusive === h.modified.startLineNumber - c.modified.endLineNumberExclusive && c.original.endLineNumberExclusive < h.original.startLineNumber && c.modified.endLineNumberExclusive < h.modified.startLineNumber)), new yt(a, [], r.quitEarly);
  }
}
function Nr(e, t, n, i) {
  return new Oe(e, t, n).ComputeDiff(i);
}
let Vs = class {
  constructor(t) {
    const n = [], i = [];
    for (let s = 0, r = t.length; s < r; s++)
      n[s] = Fn(t[s], 1), i[s] = kn(t[s], 1);
...
function U1(e) {
  ...
  for (let i = 1, s = e.length; i < s; i++) {
    ...
    Math.min(a, u) < x1 ? (n.originalLength = r.originalStart + r.originalLength - n.originalStart, n.modifiedLength = r.modifiedStart + r.modifiedLength - n.modifiedStart) : (t.push(r), n = r);
  }
  return t;
}
class pt {
  ...
  static createFromDiffResult(t, n, i, s, r, a, u) {
    ...
    if (n.originalLength === 0 ? (o = i.getStartLineNumber(n.originalStart) - 1, c = 0) : (o = i.getStartLineNumber(n.originalStart), c = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = s.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = s.getStartLineNumber(n.modifiedStart), f = s.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && r()) {
      ...
      if (b.getElements().length > 0 && L.getElements().length > 0) {
        let p = Nr(b, L, r, !0).changes;
        u && (p = U1(p)), g = [];
        for (let A = 0, x = p.length; A < x; A++)
          g.push(lt.createFromDiffChange(p[A], b, L));
      }
    }
    return new pt(
      o,
...
class pr {
  constructor(t, n, i) {
    this.shouldComputeCharChanges = i.shouldComputeCharChanges, this.shouldPostProcessCharChanges = i.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = i.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = i.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new Vs(t), this.modified = new Vs(n), this.continueLineDiff = Hs(i.maxComputationTime), this.continueCharDiff = Hs(i.maxComputationTime === 0 ? 0 : Math.min(i.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = Nr(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const u = [];
      for (let o = 0, c = n.length; o < c; o++)
        u.push(pt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[o], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: i,
        changes: u
      };
    ...
    for (let u = -1, o = n.length; u < o; u++) {
      ...
      for (; r < h && a < f; ) {
        ...
        if (g !== b) {
          {
            let L = Fn(g, 1), p = Fn(b, 1);
            for (; L > 1 && p > 1; ) {
              const A = g.charCodeAt(L - 2), x = b.charCodeAt(p - 2);
              if (A !== x)
                break;
              L--, p--;
            }
            (L > 1 || p > 1) && this._pushTrimWhitespaceCharChange(s, r + 1, 1, L, a + 1, 1, p);
          }
          {
            let L = kn(g, 1), p = kn(b, 1);
            const A = g.length + 1, x = b.length + 1;
            for (; L < A && p < x; ) {
              const R = g.charCodeAt(L - 1), U = g.charCodeAt(p - 1);
              if (R !== U)
                break;
              L++, p++;
            }
            (L < A || p < x) && this._pushTrimWhitespaceCharChange(s, r + 1, L, A, a + 1, p, x);
          }
        }
        r++, a++;
      }
      c && (s.push(pt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, c, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), r += c.originalLength, a += c.modifiedLength);
    }
    return {
      quitEarly: i,
      changes: s
  ...
  _pushTrimWhitespaceCharChange(t, n, i, s, r, a, u) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, s, r, a, u))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new lt(
      n,
      i,
      n,
      s,
  ...
  _mergeTrimWhitespaceCharChange(t, n, i, s, r, a, u) {
    ...
    if (o === 0)
      return !1;
    const c = t[o - 1];
    return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0 ? !1 : c.originalEndLineNumber === n && c.modifiedEndLineNumber === r ? (this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new lt(
      n,
      i,
      n,
      s,
      ...
      r,
      u
    )), !0) : c.originalEndLineNumber + 1 === n && c.modifiedEndLineNumber + 1 === r ? (c.originalEndLineNumber = n, c.modifiedEndLineNumber = r, this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new lt(
      n,
      i,
      n,
      s,
...
class Me {
  static trivial(t, n) {
    return new Me([new K(W.ofLength(t.length), W.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new Me([new K(W.ofLength(t.length), W.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class K {
  static invert(t, n) {
    const i = [];
    return Pr(t, (s, r) => {
      i.push(K.fromOffsetPairs(s ? s.getEndExclusives() : De.zero, r ? r.getStarts() : new De(
        n,
  ...
  static fromOffsetPairs(t, n) {
    return new K(new W(t.offset1, n.offset1), new W(t.offset2, n.offset2));
  }
  constructor(t, n) {
...
const Ge = class Ge {
  ...
  delta(t) {
    return t === 0 ? this : new Ge(this.offset1 + t, this.offset2 + t);
  }
  equals(t) {
    return this.offset1 === t.offset1 && this.offset2 === t.offset2;
  }
};
Ge.zero = new Ge(0, 0), Ge.max = new Ge(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
let De = Ge;
const tn = class tn {
  isValid() {
    return !0;
...
let Yt = wt;
class T1 {
  compute(t, n, i = Dt.instance, s) {
    if (t.length === 0 || n.length === 0)
      return Me.trivial(t, n);
    const r = new an(t.length, n.length), a = new an(t.length, n.length), u = new an(t.length, n.length);
    for (let L = 0; L < t.length; L++)
      for (let p = 0; p < n.length; p++) {
        if (!i.isValid())
          return Me.trivialTimedOut(t, n);
        const A = L === 0 ? 0 : r.get(L - 1, p), x = p === 0 ? 0 : r.get(L, p - 1);
        let R;
        t.getElement(L) === n.getElement(p) ? (L === 0 || p === 0 ? R = 0 : R = r.get(L - 1, p - 1), L > 0 && p > 0 && a.get(L - 1, p - 1) === 3 && (R += u.get(L - 1, p - 1)), R += s ? s(L, p) : 1) : R = -1;
        const U = Math.max(A, x, R);
        if (U === R) {
          const w = L > 0 && p > 0 ? u.get(L - 1, p - 1) : 0;
          u.set(L, p, w + 1), a.set(L, p, 3);
        } else U === A ? (u.set(L, p, 0), a.set(L, p, 1)) : U === x && (u.set(L, p, 0), a.set(L, p, 2));
        r.set(L, p, U);
      }
    const o = [];
    let c = t.length, h = n.length;
    function f(L, p) {
      (L + 1 !== c || p + 1 !== h) && o.push(new K(new W(L + 1, c), new W(p + 1, h))), c = L, h = p;
    }
    let g = t.length - 1, b = n.length - 1;
    for (; g >= 0 && b >= 0; )
      a.get(g, b) === 3 ? (f(g, b), g--, b--) : a.get(g, b) === 1 ? g-- : b--;
    return f(-1, -1), o.reverse(), new Me(o, !1);
  }
}
class wr {
  compute(t, n, i = Dt.instance) {
    if (t.length === 0 || n.length === 0)
      return Me.trivial(t, n);
    const s = t, r = n;
    function a(p, A) {
      for (; p < s.length && A < r.length && s.getElement(p) === r.getElement(A); )
        p++, A++;
      return p;
    }
    let u = 0;
    ...
    o.set(0, a(0, 0));
    const c = new F1();
    c.set(0, o.get(0) === 0 ? null : new qs(null, 0, 0, o.get(0)));
    let h = 0;
    e: for (; ; ) {
      if (u++, !i.isValid())
        return Me.trivialTimedOut(s, r);
      const p = -Math.min(u, r.length + u % 2), A = Math.min(u, s.length + u % 2);
      for (h = p; h <= A; h += 2) {
        const x = h === A ? -1 : o.get(h + 1), R = h === p ? -1 : o.get(h - 1) + 1, U = Math.min(Math.max(x, R), s.length), w = U - h;
        if (U > s.length || w > r.length)
          continue;
        const E = a(U, w);
        o.set(h, E);
        const D = U === x ? c.get(h + 1) : c.get(h - 1);
        if (c.set(h, E !== U ? new qs(D, U, w, E - U) : D), o.get(h) === s.length && o.get(h) - h === r.length)
          break e;
      }
    }
    let f = c.get(h);
    ...
    for (; ; ) {
      const p = f ? f.x + f.length : 0, A = f ? f.y + f.length : 0;
      if ((p !== b || A !== L) && g.push(new K(new W(p, b), new W(A, L))), !f)
        break;
      b = f.x, L = f.y, f = f.prev;
    }
    return g.reverse(), new Me(g, !1);
  }
}
class qs {
  constructor(t, n, i, s) {
...
class Qt {
  constructor(t, n, i) {
    ...
    let s = !1;
    n.start > 0 && n.endExclusive >= t.length && (n = new W(n.start - 1, n.endExclusive), s = !0), this.lineRange = n, this.firstCharOffsetByLine[0] = 0;
  ...
  getBoundaryScore(t) {
    const n = Gs(t > 0 ? this.elements[t - 1] : -1), i = Gs(t < this.elements.length ? this.elements[t] : -1);
    if (n === J.LineBreakCR && i === J.LineBreakLF)
      return 0;
    if (n === J.LineBreakLF)
      return 150;
    let s = 0;
    return n !== i && (s += 10, n === J.WordLower && i === J.WordUpper && (s += 1)), s += Ws(n), s += Ws(i), s;
  }
  translateOffset(t) {
    if (this.lineRange.isEmpty)
      return new te(this.lineRange.start + 1, 1);
    const n = Et(this.firstCharOffsetByLine, (i) => i <= t);
    return new te(
  ...
  translateRange(t) {
    return y.fromPositions(this.translateOffset(t.start), this.translateOffset(t.endExclusive));
  }
  findWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !un(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && un(this.elements[n - 1]); )
      n--;
    let i = t;
    for (; i < this.elements.length && un(this.elements[i]); )
      i++;
    return new W(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = ut(this.firstCharOffsetByLine, (s) => s <= t.start) ?? 0, i = kr(this.firstCharOffsetByLine, (s) => t.endExclusive <= s) ?? this.elements.length;
    return new W(n, i);
  }
}
function un(e) {
...
function Gs(e) {
  return e === d.LineFeed ? J.LineBreakLF : e === d.CarriageReturn ? J.LineBreakCR : In(e) ? J.Space : e >= d.a && e <= d.z ? J.WordLower : e >= d.A && e <= d.Z ? J.WordUpper : e >= d.Digit0 && e <= d.Digit9 ? J.WordNumber : e === -1 ? J.End : e === d.Comma || e === d.Semicolon ? J.Separator : J.Other;
}
function I1(e, t, n, i, s, r) {
  let { moves: a, excludedChanges: u } = P1(e, t, n, r);
  if (!r.isValid())
    return [];
  const o = e.filter((h) => !u.has(h)), c = B1(o, i, s, t, n, r);
  return Or(a, c), a = O1(a), a = a.filter((h) => {
    const f = h.original.toOffsetRange().slice(t).map((b) => b.trim());
    return f.join(`
`).length >= 15 && S1(f, (b) => b.length >= 2) >= 2;
  }), a = y1(e, a), a;
}
function S1(e, t) {
  let n = 0;
...
function P1(e, t, n, i) {
  const s = [], r = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new Yt(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new Yt(o.modified, n, o))), u = /* @__PURE__ */ new Set();
  for (const o of r) {
    let c = -1, h;
    for (const f of a) {
    ...
    if (c > 0.9 && h && (a.delete(h), s.push(new Ee(o.range, h.range)), u.add(o.source), u.add(h.source)), !i.isValid())
...
function B1(e, t, n, i, s, r) {
  ...
  const o = [];
  e.sort(_t((g) => g.modified.startLineNumber, bt));
  for (const g of e) {
    let b = [];
    for (let L = g.modified.startLineNumber; L < g.modified.endLineNumberExclusive - 2; L++) {
      const p = `${n[L - 1]}:${n[L + 1 - 1]}:${n[L + 2 - 1]}`, A = new V(L, L + 3), x = [];
      u.forEach(p, ({ range: R }) => {
        for (const w of b)
          if (w.originalLineRange.endLineNumberExclusive + 1 === R.endLineNumberExclusive && w.modifiedLineRange.endLineNumberExclusive + 1 === A.endLineNumberExclusive) {
            w.originalLineRange = new V(
              w.originalLineRange.startLineNumber,
              R.endLineNumberExclusive
            ), w.modifiedLineRange = new V(
  ...
  o.sort(yr(_t((g) => g.modifiedLineRange.length, bt)));
  const c = new Re(), h = new Re();
  for (const g of o) {
    const b = g.modifiedLineRange.startLineNumber - g.originalLineRange.startLineNumber, L = c.subtractFrom(g.modifiedLineRange), p = h.subtractFrom(g.originalLineRange).getWithDelta(b), A = L.getIntersection(p);
    for (const x of A.ranges) {
      if (x.length < 3)
        continue;
      const R = x, U = x.delta(-b);
      a.push(new Ee(U, R)), c.addRange(R), h.addRange(U);
    }
  }
  a.sort(_t((g) => g.original.startLineNumber, bt));
  const f = new Vt(e);
  for (let g = 0; g < a.length; g++) {
    const b = a[g], L = f.findLastMonotonous((D) => D.original.startLineNumber <= b.original.startLineNumber), p = ut(e, (D) => D.modified.startLineNumber <= b.modified.startLineNumber), A = Math.max(b.original.startLineNumber - L.original.startLineNumber, b.modified.startLineNumber - p.modified.startLineNumber), x = f.findLastMonotonous((D) => D.original.startLineNumber < b.original.endLineNumberExclusive), R = ut(e, (D) => D.modified.startLineNumber < b.modified.endLineNumberExclusive), U = Math.max(x.original.endLineNumberExclusive - b.original.endLineNumberExclusive, R.modified.endLineNumberExclusive - b.modified.endLineNumberExclusive);
    let w;
    for (w = 0; w < A; w++) {
      const D = b.original.startLineNumber - w - 1, T = b.modified.startLineNumber - w - 1;
      if (D > i.length || T > s.length || c.contains(T) || h.contains(D) || !$s(i[D - 1], s[T - 1], r))
        break;
    }
    w > 0 && (h.addRange(new V(b.original.startLineNumber - w, b.original.startLineNumber)), c.addRange(new V(b.modified.startLineNumber - w, b.modified.startLineNumber)));
    let E;
    for (E = 0; E < U; E++) {
      const D = b.original.endLineNumberExclusive + E, T = b.modified.endLineNumberExclusive + E;
      if (D > i.length || T > s.length || c.contains(T) || h.contains(D) || !$s(i[D - 1], s[T - 1], r))
        break;
    }
    E > 0 && (h.addRange(new V(
      b.original.endLineNumberExclusive,
      b.original.endLineNumberExclusive + E
    )), c.addRange(new V(
      b.modified.endLineNumberExclusive,
      b.modified.endLineNumberExclusive + E
    ))), (w > 0 || E > 0) && (a[g] = new Ee(new V(
      b.original.startLineNumber - w,
      b.original.endLineNumberExclusive + E
    ), new V(
      b.modified.startLineNumber - w,
      b.modified.endLineNumberExclusive + E
    )));
  }
  return a;
...
function $s(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const s = new wr().compute(new Qt([e], new W(0, 1), !1), new Qt([t], new W(0, 1), !1), n);
  let r = 0;
  const a = K.invert(s.diffs, e.length);
  for (const h of a)
...
function O1(e) {
  if (e.length === 0)
    return e;
  e.sort(_t((n) => n.original.startLineNumber, bt));
  const t = [e[0]];
...
function y1(e, t) {
  const n = new Vt(e);
  return t = t.filter((i) => {
    const s = n.findLastMonotonous((u) => u.original.startLineNumber < i.original.endLineNumberExclusive) || new Ee(new V(1, 1), new V(1, 1)), r = ut(e, (u) => u.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return s !== r;
  }), t;
}
function zs(e, t, n) {
  let i = n;
  return i = js(e, t, i), i = js(e, t, i), i = V1(e, t, i), i;
}
function js(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let r = 1; r < n.length; r++) {
    ...
    if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
      ...
      for (c = 1; c <= o && !(e.getElement(u.seq1Range.start - c) !== e.getElement(u.seq1Range.endExclusive - c) || t.getElement(u.seq2Range.start - c) !== t.getElement(u.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === o) {
        i[i.length - 1] = new K(new W(a.seq1Range.start, u.seq1Range.endExclusive - o), new W(a.seq2Range.start, u.seq2Range.endExclusive - o));
        continue;
      }
      u = u.delta(-c);
    }
  ...
  for (let r = 0; r < i.length - 1; r++) {
    ...
    if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
      ...
      for (c = 0; c < o && !(!e.isStronglyEqual(u.seq1Range.start + c, u.seq1Range.endExclusive + c) || !t.isStronglyEqual(u.seq2Range.start + c, u.seq2Range.endExclusive + c)); c++)
        ;
      if (c === o) {
        i[r + 1] = new K(new W(u.seq1Range.start + o, a.seq1Range.endExclusive), new W(u.seq2Range.start + o, a.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (u = u.delta(c));
    }
...
function V1(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    ...
    r.seq1Range.isEmpty ? n[i] = Xs(r, e, t, u, o) : r.seq2Range.isEmpty && (n[i] = Xs(r.swap(), t, e, o, u).swap());
  }
  return n;
}
...
function H1(e, t, n) {
  ...
  for (const s of n) {
    ...
    s.seq1Range.start - r.seq1Range.endExclusive <= 2 || s.seq2Range.start - r.seq2Range.endExclusive <= 2 ? i[i.length - 1] = new K(r.seq1Range.join(s.seq1Range), r.seq2Range.join(s.seq2Range)) : i.push(s);
  }
  return i;
}
function q1(e, t, n) {
  const i = K.invert(n, e.length), s = [];
  let r = new De(0, 0);
  function a(o, c) {
    ...
    let L = b.seq1Range.length, p = b.seq2Range.length;
    for (; i.length > 0; ) {
      const A = i[0];
      if (!(A.seq1Range.intersects(g.seq1Range) || A.seq2Range.intersects(g.seq2Range)))
        break;
      const R = e.findWordContaining(A.seq1Range.start), U = t.findWordContaining(A.seq2Range.start), w = new K(R, U), E = w.intersect(A);
      if (L += E.seq1Range.length, p += E.seq2Range.length, g = g.join(w), g.seq1Range.endExclusive >= A.seq1Range.endExclusive)
        i.shift();
      else
        break;
    }
    L + p < (g.seq1Range.length + g.seq2Range.length) * 2 / 3 && s.push(g), r = g.getEndExclusives();
  }
  for (; i.length > 0; ) {
    const o = i.shift();
...
function $1(e, t, n) {
  ...
  do {
    ...
    for (let o = 1; o < i.length; o++) {
      let f = function(b, L) {
        const p = new W(h.seq1Range.endExclusive, c.seq1Range.start);
        if (e.countLinesIn(p) > 5 || p.length > 500)
          return !1;
        const x = e.getText(p).trim();
        if (x.length > 20 || x.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const R = e.countLinesIn(b.seq1Range), U = b.seq1Range.length, w = t.countLinesIn(b.seq2Range), E = b.seq2Range.length, D = e.countLinesIn(L.seq1Range), T = L.seq1Range.length, I = t.countLinesIn(L.seq2Range), $ = L.seq2Range.length, ne = 2 * 40 + 50;
        function v(N) {
          return Math.min(N, ne);
        }
        return Math.pow(Math.pow(v(R * 40 + U), 1.5) + Math.pow(v(w * 40 + E), 1.5), 1.5) + Math.pow(Math.pow(v(D * 40 + T), 1.5) + Math.pow(v(I * 40 + $), 1.5), 1.5) > (ne ** 1.5) ** 1.5 * 1.3;
      };
  ...
  return Br(i, (u, o, c) => {
    ...
    const p = K.fromOffsetPairs(u ? u.getEndExclusives() : De.zero, c ? c.getStarts() : De.max), A = h.intersect(p);
...
class Ys {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : Qs(this.lines[t - 1]), i = t === this.lines.length ? 0 : Qs(this.lines[t]);
    return 1e3 - (n + i);
  }
  getText(t) {
...
class z1 {
  constructor() {
    this.dynamicProgrammingDiffing = new T1(), this.myersDiffingAlgorithm = new wr();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && Ir(t, n, (E, D) => E === D))
      return new yt([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new yt([
        new Te(new V(1, t.length + 1), new V(1, n.length + 1), [
          new Ve(new y(
            1,
            1,
            t.length,
    ...
    const s = i.maxComputationTimeMs === 0 ? Dt.instance : new D1(i.maxComputationTimeMs), r = !i.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function u(E) {
      let D = a.get(E);
      return D === void 0 && (D = a.size, a.set(E, D)), D;
    }
    const o = t.map((E) => u(E.trim())), c = n.map((E) => u(E.trim())), h = new Ys(o, t), f = new Ys(c, n), g = h.length + f.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, f, s, (E, D) => t[E] === n[D] ? n[D].length === 0 ? 0.1 : 1 + Math.log(1 + n[D].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, f, s);
    let b = g.diffs, L = g.hitTimeout;
    b = zs(h, f, b), b = G1(h, f, b);
    const p = [], A = (E) => {
      if (r)
        for (let D = 0; D < E; D++) {
          const T = x + D, I = R + D;
          if (t[T] !== n[I]) {
            const $ = this.refineDiff(t, n, new K(new W(T, T + 1), new W(I, I + 1)), s, r);
    ...
    let x = 0, R = 0;
    for (const E of b) {
      Xt(() => E.seq1Range.start - x === E.seq2Range.start - R);
      const D = E.seq1Range.start - x;
      A(D), x = E.seq1Range.endExclusive, R = E.seq2Range.endExclusive;
      const T = this.refineDiff(t, n, E, s, r);
      T.hitTimeout && (L = !0);
    ...
    const U = Zs(p, t, n);
    let w = [];
    return i.computeMoves && (w = this.computeMoves(U, t, n, o, c, s, r)), Xt(() => {
      function E(T, I) {
      ...
      for (const T of U) {
        ...
        for (const I of T.innerChanges)
          if (!(E(I.modifiedRange.getStartPosition(), n) && E(I.modifiedRange.getEndPosition(), n) && E(I.originalRange.getStartPosition(), t) && E(I.originalRange.getEndPosition(), t)))
            return !1;
  ...
  computeMoves(t, n, i, s, r, a, u) {
    return I1(t, n, i, s, r, a).map((h) => {
      const f = this.refineDiff(n, i, new K(h.original.toOffsetRange(), h.modified.toOffsetRange()), a, u), g = Zs(f.mappings, n, i, !0);
      return new Hn(h, g);
    });
  }
  refineDiff(t, n, i, s, r) {
    const a = new Qt(t, i.seq1Range, r), u = new Qt(n, i.seq2Range, r), o = a.length + u.length < 500 ? this.dynamicProgrammingDiffing.compute(a, u, s) : this.myersDiffingAlgorithm.compute(a, u, s);
    let c = o.diffs;
    return c = zs(a, u, c), c = q1(a, u, c), c = H1(a, u, c), c = $1(a, u, c), {
      mappings: c.map((f) => new Ve(a.translateRange(f.seq1Range), u.translateRange(f.seq2Range))),
...
function Zs(e, t, n, i = !1) {
  const s = [];
  for (const r of Sr(e.map((a) => j1(a, t, n)), (a, u) => a.original.overlapOrTouch(u.original) || a.modified.overlapOrTouch(u.modified))) {
  ...
  return Xt(() => !i && s.length > 0 && (s[0].modified.startLineNumber !== s[0].original.startLineNumber || n.length - s[s.length - 1].modified.endLineNumberExclusive !== t.length - s[s.length - 1].original.endLineNumberExclusive) ? !1 : Lr(s, (r, a) => a.original.startLineNumber - r.original.endLineNumberExclusive === a.modified.startLineNumber - r.modified.endLineNumberExclusive && r.original.endLineNumberExclusive < a.original.startLineNumber && r.modified.endLineNumberExclusive < a.modified.startLineNumber)), s;
}
function j1(e, t, n) {
  let i = 0, s = 0;
...
class ee {
  constructor(t, n, i, s = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, t)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, i)) | 0, this.a = He(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
...
class be {
  constructor(t, n, i, s) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = He(Math.max(Math.min(1, n), 0), 3), this.l = He(Math.max(Math.min(1, i), 0), 3), this.a = He(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
  ...
  static toRGBA(t) {
    ...
    if (i === 0)
      ...
      a = be._hue2rgb(h, c, n + 1 / 3), u = be._hue2rgb(h, c, n), o = be._hue2rgb(h, c, n - 1 / 3);
    }
    return new ee(Math.round(a * 255), Math.round(u * 255), Math.round(o * 255), r);
  }
}
class et {
  constructor(t, n, i, s) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = He(Math.max(Math.min(1, n), 0), 3), this.v = He(Math.max(Math.min(1, i), 0), 3), this.a = He(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    ...
    let c;
    return u === 0 ? c = 0 : r === n ? c = ((i - s) / u % 6 + 6) % 6 : r === i ? c = (s - n) / u + 2 : c = (n - i) / u + 4, new et(Math.round(c * 60), o, r, t.a);
  }
  static toRGBA(t) {
    const { h: n, s: i, v: s, a: r } = t, a = s * i, u = a * (1 - Math.abs(n / 60 % 2 - 1)), o = s - a;
    let [c, h, f] = [0, 0, 0];
    return n < 60 ? (c = a, h = u) : n < 120 ? (c = u, h = a) : n < 180 ? (h = a, f = u) : n < 240 ? (h = u, f = a) : n < 300 ? (c = u, f = a) : n <= 360 && (c = a, f = u), c = Math.round((c + o) * 255), h = Math.round((h + o) * 255), f = Math.round((f + o) * 255), new ee(c, h, f, r);
  }
}
const G = class G {
  static fromHex(t) {
  ...
  constructor(t) {
    if (t)
      if (t instanceof ee)
        ...
        this._hsla = t, this.rgba = be.toRGBA(t);
      else if (t instanceof et)
        this._hsva = t, this.rgba = et.toRGBA(t);
      else
        throw new Error("Invalid color ctor argument");
    else throw new Error("Color needs a value");
  }
  equals(t) {
    return !!t && ee.equals(this.rgba, t.rgba) && be.equals(this.hsla, t.hsla) && et.equals(this.hsva, t.hsva);
  }
  ...
  lighten(t) {
    return new G(new be(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new G(new be(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
  ...
  opposite() {
    return new G(new ee(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  blend(t) {
...
G.white = new G(new ee(255, 255, 255, 1)), G.black = new G(new ee(0, 0, 0, 1)), G.red = new G(new ee(255, 0, 0, 1)), G.blue = new G(new ee(0, 0, 255, 1)), G.green = new G(new ee(0, 255, 0, 1)), G.cyan = new G(new ee(0, 255, 255, 1)), G.lightgrey = new G(new ee(211, 211, 211, 1)), G.transparent = new G(new ee(0, 0, 0, 0));
let ft = G;
(function(e) {
  (function(t) {
    (function(n) {
      ...
      function f(b) {
        ...
        if (L === 0 || b.charCodeAt(0) !== d.Hash)
          return null;
        if (L === 7) {
          const p = 16 * g(b.charCodeAt(1)) + g(b.charCodeAt(2)), A = 16 * g(b.charCodeAt(3)) + g(b.charCodeAt(4)), x = 16 * g(b.charCodeAt(5)) + g(b.charCodeAt(6));
          return new e(new ee(p, A, x, 1));
        }
        if (L === 9) {
          const p = 16 * g(b.charCodeAt(1)) + g(b.charCodeAt(2)), A = 16 * g(b.charCodeAt(3)) + g(b.charCodeAt(4)), x = 16 * g(b.charCodeAt(5)) + g(b.charCodeAt(6)), R = 16 * g(b.charCodeAt(7)) + g(b.charCodeAt(8));
          return new e(new ee(p, A, x, R / 255));
        }
        if (L === 4) {
          const p = g(b.charCodeAt(1)), A = g(b.charCodeAt(2)), x = g(b.charCodeAt(3));
          return new e(new ee(16 * p + p, 16 * A + A, 16 * x + x));
        }
        if (L === 5) {
          const p = g(b.charCodeAt(1)), A = g(b.charCodeAt(2)), x = g(b.charCodeAt(3)), R = g(b.charCodeAt(4));
          return new e(new ee(16 * p + p, 16 * A + A, 16 * x + x, (16 * R + R) / 255));
        }
        return null;
      }
      n.parseHex = f;
...
function X1(e, t) {
  if (!e)
    return;
  const n = ft.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
...
function Ks(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const s = t[0].values(), r = Er(s), a = new ft(new be(
    r[0],
    r[1] / 100,
    r[2] / 100,
    n ? r[3] : 1
  ...
  return {
    range: e,
    color: qn(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function gt(e, t) {
...
function Y1(e) {
  const t = [], i = gt(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (i.length > 0)
    for (const s of i) {
...
function Ar(e) {
  ...
  return e = e.replace(Z1, ""), { text: e, hasSeparatorLine: t };
}
class ta extends Jl {
  get uri() {
    return this._uri;
  ...
  findMatches(t) {
    ...
    for (let i = 0; i < this._lines.length; i++) {
      const s = this._lines[i], r = this.offsetAt(new te(i + 1, 1)), a = s.matchAll(t);
      for (const u of a)
  ...
  getWordAtPosition(t, n) {
    const i = On(t.column, br(n), this._lines[t.lineNumber - 1], 0);
    return i ? new y(
      t.lineNumber,
      i.startColumn,
      t.lineNumber,
...
const Be = class Be {
  ...
  acceptNewModel(t) {
    this._models[t.url] = new ta(je.parse(t.url), t.lines, t.EOL, t.versionId);
  }
  ...
  async computeUnicodeHighlights(t, n, i) {
    ...
    return s ? w1.computeUnicodeHighlights(s, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async computeDiff(t, n, i, s) {
    ...
    return !r || !a ? null : Be.computeDiff(r, a, i, s);
  }
  static computeDiff(t, n, i, s) {
    const r = s === "advanced" ? on.getDefault() : on.getLegacy(), a = t.getLinesContent(), u = n.getLinesContent(), o = r.computeDiff(a, u, i), c = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function h(f) {
      return f.map(
        (g) => {
          var b;
  ...
  async computeMoreMinimalEdits(t, n, i) {
    ...
    n = n.slice(0).sort((o, c) => {
      if (o.range && c.range)
        return y.compareRangesUsingStarts(o.range, c.range);
      const h = o.range ? 0 : 1, f = c.range ? 0 : 1;
      return h - f;
    });
    let u = 0;
    for (let o = 1; o < n.length; o++)
      y.getEndPosition(n[u].range).equals(y.getStartPosition(n[o].range)) ? (n[u].range = y.fromPositions(y.getStartPosition(n[u].range), y.getEndPosition(n[o].range)), n[u].text += n[o].text) : (u++, n[u] = n[o]);
    n.length = u + 1;
    for (let { range: o, text: c, eol: h } of n) {
      if (typeof h == "number" && (a = h), y.isEmpty(o) && !c)
        continue;
      const f = s.getValueInRange(o);
      if (c = c.replace(/\r\n|\n|\r/g, s.eol), f === c)
        continue;
      if (Math.max(c.length, f.length) > Be._diffLimit) {
        r.push({ range: o, text: c });
        continue;
      }
      const g = Fl(f, c, i), b = s.offsetAt(y.lift(o).getStartPosition());
      for (const L of g) {
        const p = s.positionAt(b + L.originalStart), A = s.positionAt(b + L.originalStart + L.originalLength), x = {
  ...
  computeHumanReadableDiff(t, n, i) {
    ...
    n = n.slice(0).sort((u, o) => {
      if (u.range && o.range)
        return y.compareRangesUsingStarts(u.range, o.range);
    ...
    for (let { range: u, text: o, eol: c } of n) {
      let p = function(x, R) {
        ...
        for (let w = R.startLineNumber; w <= R.endLineNumber; w++) {
          const E = x[w - 1];
          w === R.startLineNumber && w === R.endLineNumber ? U.push(E.substring(R.startColumn - 1, R.endColumn - 1)) : w === R.startLineNumber ? U.push(E.substring(R.startColumn - 1)) : w === R.endLineNumber ? U.push(E.substring(0, R.endColumn - 1)) : U.push(E);
        }
        return U;
      };
      if (typeof c == "number" && (a = c), y.isEmpty(u) && !o)
        continue;
      const h = s.getValueInRange(u);
      if (o = o.replace(/\r\n|\n|\r/g, s.eol), h === o)
        continue;
      if (Math.max(o.length, h.length) > Be._diffLimit) {
        r.push({ range: u, text: o });
        continue;
      }
      const f = h.split(/\r\n|\n|\r/), g = o.split(/\r\n|\n|\r/), b = on.getDefault().computeDiff(f, g, i), L = y.lift(u).getStartPosition();
      for (const x of b.changes)
        if (x.innerChanges)
          for (const R of x.innerChanges)
            r.push({
              range: y.fromPositions(p(L, R.originalRange.getStartPosition()), p(L, R.originalRange.getEndPosition())),
  ...
  async textualSuggest(t, n, i, s) {
    const r = new nn(), a = new RegExp(i, s), u = /* @__PURE__ */ new Set();
    e: for (const o of t) {
  ...
  async navigateValueSet(t, n, i, s, r) {
    ...
    return En.INSTANCE.navigateValueSet(n, o, c, h, i);
  }
  loadForeignModule(t, n, i) {
    const a = {
      host: el(i, (u, o) => this._host.fhr(u, o)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(a, n), Promise.resolve(bn(this._foreignModule))) : Promise.reject(new Error("Unexpected usage"));
  }
  fmr(t, n) {
...
Be._diffLimit = 1e5, Be._suggestionsLimit = 1e4;
let Sn = Be;
typeof importScripts == "function" && (globalThis.monaco = _1());
let Pn = !1;
function na(e) {
  if (Pn)
    return;
